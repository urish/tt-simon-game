...
- `1`: internal clock, generated by the `ring_osc` module, with a frequency of ~50 kHz.

The internal clock is generated by a 13-stage ring oscillator (~819 MHz on silicon), divided by 16384 to land near 50 kHz, matching the external-clock case. The divide ratio was set by silicon measurement of this design on the TTSKY26a silicon (`uo_out[7]` ≈ 100 kHz with the previous /8192 divider).
