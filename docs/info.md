...
- `1`: internal clock, generated by the `ring_osc` module, with unknown frequency (to be characterized on TTGF0p2 silicon).

The internal clock is generated by a ring oscillator divided down towards ~50 kHz.
